...
const CalenderWeek = (props) =>{
    ...
    return(
        ...
        <Card className ={bgclass} >
           ...
           <Card.Header as='h6' className='rightAlign'>{myDate.toLocaleString('default', { weekday: 'long'})} {myDate.toLocaleDateString()}</Card.Header>
           <Card.Body>
                
               
               <Form.Group >
                    <Form.Check  type="checkbox" label="Promo Change Over" onChange={handlePromoChange} defaultChecked = {promoCheck}/>
                </Form.Group>
                <Form.Group >
                    <Form.Check  type="checkbox" label="Seasonal Week" onChange={handleSeasonalChange} defaultChecked={seasonCheck}/>
                </Form.Group>
           </Card.Body>
        </Card>

        ...
        return(
          <>
            <tr className={bgClass } onClick={handleShow}>
              ...
              <td className={'p_cell ' + getHighlight}>{nextDate.toLocaleDateString() + overText}</td>     
            </tr>
            ...
            <Modal.Header closeButton>
              <Modal.Title>{props.location.group_name} - Last Cleaned Date</Modal.Title>
            </Modal.Header>
            <Modal.Body>
                <Form.Group controlId="lc">
                    <Form.Label>Select Last Cleaned Date</Form.Label>
                    <Form.Control type="date" name="lc" placeholder="Last Cleaned" onChange={handleChangeDate}/>
                </Form.Group>
            </Modal.Body>
            <Modal.Footer>
